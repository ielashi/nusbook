<?php
	...
	$lang = array_merge($lang,array(
		"ACCOUNT_LOGIN"							=> "You must be logged in to view this page.",
	...
	$lang = array_merge($lang,array(
		"REGISTRATION_SUCCESS"					=> "Registration complete! You can now logon and start sharing your interests!",
	));
	
	//Groups
	$lang = array_merge($lang,array(
		"DELETE_GROUP_SUCCESS"					=> "Deletion of the group was successfull.",
		"UNJOIN_SUCCESS"						=> "You are no longer in that group.",
		"JOIN_SUCCESS"							=> "You are now in that group.",
		
	));
	
	//Posts
	$lang = array_merge($lang,array(
		"DELETE_SUCCESS"						=> "Deletion of the post was successfull.",
	));
?>